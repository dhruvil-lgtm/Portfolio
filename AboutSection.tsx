...
export function AboutSection() {
  return (
    <section id="about" className="relative min-h-screen bg-[#0C0C0C] px-5 sm:px-8 md:px-10 py-20 flex items-center justify-center overflow-hidden">
      {/* Decorative images */}
      <FadeIn
        as="img"
        delay={0.1}
      ...
      <div className="relative z-10 flex flex-col items-center gap-10 sm:gap-14 md:gap-16">
        ...
        <AnimatedText
          text="with 6+ months of experience in design, i focus on branding, smooth web design, and adaptable UI/UX. i truly enjoy using ai to build websites"
